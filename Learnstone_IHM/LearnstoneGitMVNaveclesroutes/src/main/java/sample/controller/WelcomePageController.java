...
public class WelcomePageController implements Initializable{
    ...
    @FXML private Label labelClickHere;
    ...
    private Image image = new Image(String.valueOf(getClass().getClassLoader().getResource("images/learnstone3.png")));
    private Image imagegif = new Image(String.valueOf(getClass().getClassLoader().getResource("images/welcome.gif")));
    ...
    private void fadingInWhenMouseEntered(Node node, int time){
        ...
        fadeTransition.play();
//        imageTopCenter.setImage(imagegif);
    }
